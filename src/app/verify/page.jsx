...
function VerifyContent() {
  ...
  return (
    <div className="min-h-screen flex flex-col text-slate-800">
      <SiteHeader />
      <main className="flex-1 mx-auto max-w-2xl w-full px-4 py-16 sm:px-6">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-black text-slate-900 sm:text-4xl">Hujjat tekshiruvi</h1>
        ...
        <div className="fath-shell rounded-2xl p-6 sm:p-8">
          ...
          <div className="flex gap-3">
            <input
              ...
              maxLength={13}
              className="flex-1 rounded-lg border border-cyan-200 px-4 py-3 text-lg font-mono tracking-widest text-center focus:border-cyan-500 focus:ring-2 focus:ring-cyan-200 outline-none"
            />
            <button
              onClick={() => verify()}
              disabled={loading || !code.trim()}
              className="rounded-lg bg-cyan-600 px-6 py-3 text-sm font-bold text-white hover:bg-cyan-700 disabled:opacity-50 transition-colors"
            >
          ...
          {result && (
            <div className={`mt-6 rounded-xl p-6 ${result.valid ? 'bg-emerald-50 border border-emerald-200' : 'bg-rose-50 border border-rose-200'}`}>
                ...
                <div className="flex-1">
                  ...
                  {result.valid && result.license && (
                    <div className="mt-4 space-y-2 text-sm text-slate-700">
                      <div className="grid grid-cols-2 gap-x-4 gap-y-2 rounded-lg bg-white/60 p-4">
